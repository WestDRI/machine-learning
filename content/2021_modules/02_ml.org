...
#+BEGIN_export html
<a href="https://westgrid-slides.netlify.app/fastai_1/#/"><p align="center"><img src="/img/fastai_1_slides.png" title="" width="100%" style="border-style: solid; border-width: 1.5px 1.5px 0 2px; border-color: black"/></p></a>
#+END_export
...
*In short, deep learning is a subfield of machine learning which is itself a subfield of the must larger field of artificial intelligence.*
