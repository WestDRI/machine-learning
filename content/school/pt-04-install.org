...
#+BEGIN_box
You will learn [[https://westgrid-ml.netlify.app/school/pt-08-hpc.html][tomorrow]] how to run ML scripts in Compute Canada clusters. But for the purpose of this course and while using our training cluster, all you will have to do before running PyTorch scripts is to:
