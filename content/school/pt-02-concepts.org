...
RNN are used for chain structured data (e.g. text).

* Overfitting

[[https://en.wikipedia.org/wiki/Overfitting][Overfitting]] is a common problem when developing ML models.

{{<br>}}
{{<img src="/img/school/overfitting.png" title="" width="35%" line-height="0.5rem">}}
