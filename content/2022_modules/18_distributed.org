#+title: A few notes on PyTorch distributed
#+description: Reading
#+colordes: #999999
#+slug: 18_distributed
#+weight: 18
...
*Before you consider using more than 1 GPU on the Alliance clusters, you should carefully analyze whether this will truly benefit your model.*

With the explosion of the field of machine learning in recent years, the GPUs in the Alliance clusters have seen an exponential increase in demand. Resources are expanding, but cannot keep up.

{{<img src="/img/gpu_rac_2020_nw.png" margin="6rem" title="" width="100%" line-height="0rem">}}
<center>{{<m>}}{{<m>}}{{<m>}}{{<m>}}{{<m>}}{{<m>}}{{<m>}}{{<m>}}{{<m>}}From <a href="https://www.computecanada.ca/research-portal/accessing-resources/resource-allocation-competitions/">Compute Canada 2020 RAC Q&A session</a></center>
{{</img>}}
