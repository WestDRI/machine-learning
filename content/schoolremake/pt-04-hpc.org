...
Interactive jobs are useful for testing and code development.
...
For the workshop, you also don't have to worry about the ~--account=def-<user>~ option (or, if you want, you can use ~--account=def-sponsor00~).
