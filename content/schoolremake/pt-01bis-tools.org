...
It is often very difficult to have access to old versions of proprietary tools (and this can be necessary to reproduce old studies). When companies disappear, the tools they produced usually disappear with them. Open source tools, particularly those who have their code under version control in repositories such as GitHub, all stages of development remain fully accessible, and if they get abandoned, their maintenance can be taken over or restarted by others.
