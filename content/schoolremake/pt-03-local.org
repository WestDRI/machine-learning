#+title: Optional: installing PyTorch on your machine
#+description: Annex
#+colordes: #2d5986
#+slug: pt-03-local
#+weight: 3
...
{{<br>}}
/Installing PyTorch on your machine is entirely optional as you can run everything on the training cluster. If you would like to practice on your machine in addition to (or instead of) the training cluster, these should help you. Please note that you won't be debugging local installations./
